  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-14 xl:mt-20 text-base lg:text-xl xl:text-2xl">
          <span className="font-semibold text-red-500 border-2 px-6 py-4 lg:px-8 border-vividRed-900 cursor-pointer hover:text-white hover:bg-vividRed-900 duration-300 transition-all ease-in ">
            Contact me here
          </span>
        </p>
      </motion.div>
