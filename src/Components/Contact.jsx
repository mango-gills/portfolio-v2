...
const Contact = () => {
  return (
    <div
      className="bg-no-repeat bg-cover bg-[#161617] w-full h-full flex justify-center lg:justify-start lg:pl-16 xl:pl-24 items-center"
      style={{ backgroundImage: `url(${mainBg})` }}
    >
      <div className=" text-white px-8 py-12 lg:py-0 lg:w-[70%] xl:w-[62%]">
        <h1 className="text-3xl font-bold lg:text-5xl lg:mb-8 xl:text-7xl xl:mb-10">
          Get in touch
        </h1>
