  ...
  return (
    ...
    >
      <div className="space-y-4 px-8 py-4 text-white selection:bg-white selection:text-vividRed-900 lg:space-y-0 xl:max-w-[700px] 2xl:max-w-[900px]">
        ...
        <div
          className="relative h-[220px] w-full overflow-hidden bg-contain bg-top bg-no-repeat drop-shadow-lg md:h-[300px] lg:bg-cover xl:h-[300px] 2xl:h-[415px]"
          style={{ backgroundImage: `url(${project?.images[0]})` }}
        />
        <h1
          ref={ref}
          className="text-2xl font-bold text-vividRed-900 drop-shadow-dark-lg lg:py-2 lg:text-3xl xl:py-5 xl:text-4xl 2xl:py-8 2xl:text-5xl"
        >
          {project?.title}
        </h1>
        ...
        <p className="text-justify text-xs leading-relaxed md:text-sm xl:leading-6 2xl:text-lg 2xl:leading-10">
          {project?.description}
          <br />{" "}
          <a
