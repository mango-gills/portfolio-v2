...
const Projects = () => {
  return (
    <div className="bg-[#161617] pt-[120px] lg:flex lg:flex-row-reverse h-full lg:min-h-screen lg:items-center lg:justify-end lg:py-0 lg:pl-16 xl:pl-24">
      ...
      <div className="grid grid-cols-3 gap-2 px-8 lg:grid-cols-1 lg:w-[20%] xl:gap-6 lg:gap-3">
        <div className={elementStyles.projectCard}>
          <div className="flex flex-col text-center sm:text-left">
            <h1 className={elementStyles.projectCardHeading}>Project - 001</h1>

            <p className="text-sm text-white sm:text-base xl:text-lg">Title</p>
          </div>
        </div>
        <div className={elementStyles.projectCard}>
          <div className="flex flex-col text-center sm:text-left">
