...
const Projects = () => {
  return (
    <div className="bg-[#161617] pt-[120px] lg:flex lg:flex-row-reverse lg:h-full lg:items-start lg:py-12">
      <div className="pr-16 pl-4 py-4 space-y-6 text-white lg:w-[60%] lg:space-y-0">
        <h1 className="text-2xl font-bold lg:hidden">PROJECTS</h1>
        <img className="" src="./p5-1.png" alt="" />
        <h1 className="text-2xl font-bold text-red-500 lg:text-5xl lg:py-6">
          Chapp
        </h1>
        <div className="flex flex-col w-full lg:flex-row lg:justify-between lg:pb-4">
          <div className="flex lg:flex-col lg:text-2xl lg:space-y-2 space-x-2 lg:space-x-0">
            <p>Tech Stack:</p>
      ...
      <div className="grid grid-cols-3 gap-2 px-8 pt-4 pb-8 lg:grid-cols-1 lg:w-[20%] lg:gap-6">
